...
import { ArrowLeft, RefreshCw, Copy, Download, FileDown, ChevronLeft, ChevronRight } from 'lucide-react'
...
export default function BusinessCaseDetail() {
  ...
  const handleRegenerate = async () => {
    ...
    try {
      ...
      toast.success('Business case regenerated successfully!')
    } catch (error) {
      ...
      <DashboardLayout>
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <Card className="text-center py-12">
            <h3 className="text-xl font-bold mb-2">No business case found</h3>
            <p className="text-secondary mb-6">Generate your business case first</p>
      ...
      <div className="max-w-[1800px] mx-auto px-6 py-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <div className="text-sm text-gray-400 mb-2">
              Projects / {project?.business_name} / Business Case
            </div>
            <h1 className="text-4xl font-clash font-bold mb-1">Business Case</h1>
            <p className="text-gray-400">Your complete business plan and strategy</p>
          </div>
        ...
        <div className="grid grid-cols-[auto_1fr_auto] gap-6">
          ...
          >
            ...
            {/* Document Content */}
            <StructuredMarkdown content={content} type="business_case" />
          </motion.main>
